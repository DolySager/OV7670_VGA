...
# set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports {o_Hsync}];#Sch name = JC8
# set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {o_Vsync}];#Sch name = JC9
